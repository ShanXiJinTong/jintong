...
<div>
    ...
    <section class="wsq-more">
        <div class="wsq-line">
            ...
            <div class="wsq-lineR">
                <a href="">
                    <p>查看更多 <span>
            <img src="../img/rightjiantou.png" height="9" width="10"/></span></p>
                </a>
            </div>
    ...
    <footer>
        <div class="sk-tabItem hot">
            <img src="../img/footer/sy.png" alt="">
            <h3>首页</h3>
        </div>
        <div class="sk-tabItem">
            <img src="../img/footer/store.png" alt="">
            <h3>商城</h3>
        </div>
        <div class="sk-tabItem">
            <img src="../img/footer/rz.png" alt="">
            <h3>入驻</h3>
        </div>
        <div class="sk-tabItem">
            <img src="../img/footer/order.png" alt="">
            <h3>订单</h3>
        </div>
        <div class="sk-tabItem">
            <img src="../img/footer/personal.png" alt="">
            <h3>我的</h3>
        </div>
    </footer>
    <!--footer结束-->
