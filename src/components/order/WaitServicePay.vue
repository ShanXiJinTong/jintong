<template>
  <div>
    ...
    <div class="cloth">
      <div class="cleft">
        <a href="">
          <img src="./static/img/cloth.png" alt="">
        </a>
      </div>
      <div class="cright">
        <div class="rightone">潜水艇高端龙头</div>
        <div class="righttwo">
          <div class="yuanjiao"></div>
          <div class="zimu">ECC01-001Lw</div>
        </div>
        ...
        <div class="rightfour">
          ...
          <div class="er">
            ...
            <img src="./static/img/cheng.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bb">
      ...
      <span>备注</span>
      <div class="xuantian">
        选填 <input type="text" placeholder="请输入备注(25字以内)">
      </div>
    </div>
    <div class="line">
      <div class="line1"></div>
    ...
    <div class="aa">
      ...
      <div class="aright" style="display: flex;justify-content: flex-end">
        <span>¥60.00</span>
      </div>
    </div>
    <div class="line">
