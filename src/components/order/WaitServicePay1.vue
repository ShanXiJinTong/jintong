	...
	<div>
		...
		<div v-if="coinFlag" style="position: fixed;z-index: 99999;bottom: 0;left: 0;width: 100%;height: 1.7rem;background: #f3f3f3;">
			<div style="max-width: 75rem;margin: 0 auto;height: 100%;display: flex;align-items: center;justify-content: space-around;">
				<button style="width: 1.3rem;height: 0.7rem;outline: none;border: none;background: #E7F6FF;color: #3BACFE;border-radius: 5px;" @click="useCoin1(0)">不使用</button>
				<button style="width: 1.3rem;height: 0.7rem;outline: none;border: none;background: #3BACFE;color: #fff;border-radius: 5px;" @click="useCoin1(1)">使用</button>
			</div>
		</div>
		<div v-if="couFlag" style="position: fixed;bottom: 0;z-index: 9999;left: 0;width: 100%;background: #f3f3f3;">
			<ul class="tkbox">
				...
				<li class="tklist" style="height: 1rem;">
					<div style="margin: 0 auto;background: #C1C1C1;padding: 0.2rem 0.3rem;border-radius: 5px;color: #fff;" @click="useCou1(0)">不使用优惠卷</div>
				</li>
			</ul>
		</div>
	</div>
