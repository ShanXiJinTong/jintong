          ...
          <ul>
              ...
              <li class="one">
                  ...
                  <el-form-item label="" prop="email">
                      <el-input v-model="ruleForm2.email" placeholder="请填写手机号码" auto-complete="true"></el-input>
                  </el-form-item>
              ...
              <li class="four">
                  ...
                  <el-form-item label="" prop="pass">
                      <el-input type="password" v-model="ruleForm2.pass" auto-complete="off" placeholder="重复输入您的密码"></el-input>
                  </el-form-item>
    ...
    export default {
        ...
        data() {
            ...
            return {
                   ...
                   rules: {
                       email: [{ required: true, validator: validatePhone, trigger: 'blur' }],
                       password: [
